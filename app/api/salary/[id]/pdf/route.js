...
export async function GET(req, { params }) {
  ...
  let y = 780;
  page.drawText("Northstar HR", { x: 50, y, size: 20, font: bold, color: indigo });
  y -= 26;
  ...
  y -= 40;
  page.drawText("This is a system-generated document from Northstar HR.", { x: 50, y, size: 8, font, color: light });
